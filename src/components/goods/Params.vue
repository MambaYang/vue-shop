<template>
    <div>
        ...
        <el-card>
            ...
            <el-tabs v-model="activeName" @tab-click="handleTabClick">
                ...
                <el-tab-pane label="静态属性" name="only">
                    <!-- 添加属性的按钮 -->
                    <el-button type="primary" size="mini" itemref=""
                        :disabled="isBtnDisabled"
        ...
        <!-- 添加参数的对话框 -->
        <el-dialog :title="'提示'+titleText" :visible.sync="addDialogVisible"
        ...
        <!-- 修改参数的对话框 -->
        <el-dialog :title="'提示'+titleText" :visible.sync="editDialogVisible"
...
export default {
    ...
    methods: {
        ...
        showInput(row) {
            ...
            // 让文本框自动获取焦点
            // $nextTick 方法的作用，就是页面上的元素被重新渲染之后，才会指定回调函数中的代码
            this.$nextTick(_ => {
